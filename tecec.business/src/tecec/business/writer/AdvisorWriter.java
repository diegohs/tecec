...
public class AdvisorWriter implements IAdvisorWriter {
	...
	public RuleViolation getUpdateViolation(String pkAdvisor, String newName,
		...
		if (advisor == null)
			return new RuleViolation ("O orientador selecionado nÃ£o existe no banco de dados.");
		...
		if (advisor != null) {
			if (!advisor.getPKAdvisor().equals(pkAdvisor)) {
				return new RuleViolation ("JÃ¡ existe outro orientador cadastrado com este e-mail.");
			}
		}
	...
	public RuleViolation getCreationViolation(String name, String email) {
		...
		if (advisorName != null && advisorEmail != null) {
			return new RuleViolation(
					"JÃ¡ existe outro orientador cadastrado com o mesmo nome e e-mail.");
		}
		...
		if (advisorEmail != null) {
			return new RuleViolation(
					"JÃ¡ existe outro orientador cadastrado com o mesmo e-mail.");
		}
