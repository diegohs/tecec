...
public class NewAdvisorUI extends JDialog implements INewAdvisorUI {
	...
	private void createAdvisor(){
		try {
			RuleViolation violation = this.newAdvisorController.getCreationViolation();
	...
	protected void initDataBindings() {
		BeanProperty<INewAdvisorController, String> iNewAdvisorControllerBeanProperty = BeanProperty.create("advisorName");
		BeanProperty<JTextField, String> jTextFieldBeanProperty = BeanProperty.create("text");
		AutoBinding<INewAdvisorController, String, JTextField, String> autoBinding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, newAdvisorController, iNewAdvisorControllerBeanProperty, txtName, jTextFieldBeanProperty);
		autoBinding.bind();
		//
		BeanProperty<INewAdvisorController, String> iNewAdvisorControllerBeanProperty_1 = BeanProperty.create("advisorEmail");
		BeanProperty<JTextField, String> jTextFieldBeanProperty_1 = BeanProperty.create("text");
		AutoBinding<INewAdvisorController, String, JTextField, String> autoBinding_1 = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, newAdvisorController, iNewAdvisorControllerBeanProperty_1, txtEmail, jTextFieldBeanProperty_1);
		autoBinding_1.bind();
	}
}
