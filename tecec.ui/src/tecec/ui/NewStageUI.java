...
public class NewStageUI extends JDialog implements INewStageUI {
	...
	private JLabel lblCadastrarNovoEstgio;
	...
	public NewStageUI(INewStageController newStageController) {
		...
		setBounds(100, 100, 416, 198);
		getContentPane().setLayout(new BorderLayout());
		contentPanel.setBorder(new EmptyBorder(5, 5, 5, 5));
		getContentPane().add(contentPanel, BorderLayout.CENTER);
		contentPanel.setLayout(new MigLayout("", "[][180.00,grow]", "[][][][]"));
		{
			lblCadastrarNovoEstgio = new JLabel("Cadastrar novo Estágio");
			lblCadastrarNovoEstgio.setFont(new Font("DejaVu Sans", Font.BOLD, 12));
			contentPanel.add(lblCadastrarNovoEstgio, "cell 1 0,alignx center");
		}
		{
		...
		}
		{
			...
			contentPanel.add(lblAno, "cell 0 2,alignx trailing");
		}
		{
		...
		}
		{
			...
			contentPanel.add(btnCadastrar, "cell 1 3,alignx right");
		}
		initDataBindings();
	}
