...
public class UpdateCourseUI extends JDialog implements IUpdateCourseUI {
	...
	public UpdateCourseUI(IUpdateCourseController updateCourseController) {
		...
		contentPanel.setLayout(new MigLayout("", "[][][][grow][][]", "[][][][][][][][]"));
		{
			...
			contentPanel.add(lblAtualizarCurso, "cell 3 3,alignx center");
		}
		{
			JLabel lblNome = new JLabel("Nome:");
			contentPanel.add(lblNome, "cell 2 4,alignx trailing");
		}
		{
			textField = new JTextField();
			contentPanel.add(textField, "cell 3 4,growx");
			textField.setColumns(10);
		}
		{
			JLabel lblTurno = new JLabel("Turno:");
			contentPanel.add(lblTurno, "cell 2 5,alignx trailing");
		}
		{
			comboTurn = new JComboBox();
			comboTurn.setModel(new DefaultComboBoxModel(new String[] {"Noturno", "Vespertino", "Integral", "EAD", "Diurno"}));
			contentPanel.add(comboTurn, "cell 3 5,growx");
		}
		{
			JLabel lblAno = new JLabel("Ano:");
			contentPanel.add(lblAno, "cell 2 6,alignx trailing");
		}
		{
			...
			contentPanel.add(comboYear, "cell 3 6,growx");
		}
		{
			...
			contentPanel.add(btnAtualizar, "cell 3 7,alignx right");
		}
		initDataBindings();
	}
