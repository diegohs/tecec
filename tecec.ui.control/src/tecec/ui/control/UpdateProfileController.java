...
public class UpdateProfileController extends BaseController implements IUpdateProfileController {
	...
	public UpdateProfileController(IProfileWriter profileWriter, IProfileReader profileReader) {
	...
	public RuleViolation getUpdateViolation() {
		return this.profileWriter.getUpdateViolation(this.pKProfile, this.profileName);
	}
