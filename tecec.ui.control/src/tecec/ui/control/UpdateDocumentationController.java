...
public class UpdateDocumentationController extends BaseController implements IUpdateDocumentationController {
	...
	public UpdateDocumentationController (IDocumentationWriter documentationWriter,
	...
	public void setPKDocumentation(String pKDocumentation) {
		...
		Documentation documentation = this.documentationReader.getDocumentationByPK(pKDocumentation);
	...
	public boolean getCanUpdate() {
		return this.documentationData != null && this.documentationData.length >0 &&
	...
	public void updateDocumentation() throws RuleViolationException {
		...
		this.documentationWriter.updateDocumentation(this.pKDocumentation, this.fileName, this.documentationData);
